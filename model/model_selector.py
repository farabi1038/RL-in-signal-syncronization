...
def model_selector(cfg, env):
	if cfg.model.name == "ppo_v1":
		return ppo_v1(cfg, env)
	elif cfg.model.name == "dqn":
		return dqn(cfg, env)
	elif cfg.model.name == "multihead_dqn":
		return dqn_multi(cfg, env)
	elif cfg.model.name == "multihead_dqn_full":
		return dqn_multi_full(cfg, env)
	elif cfg.model.name == "multihead_dqn_full_split":
		return dqn_multi_full_split(cfg, env)
	elif cfg.model.name == "multihead_ddqn_full":
		return ddqn_multi_full(cfg, env)
	elif cfg.model.name == "multihead_dqn_full_dropout":
