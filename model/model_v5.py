...
class QFunction(chainer.Chain):
    ...
    def __init__(self, obs_size, n_actions, n_hidden_channels=128):
        ...
        with self.init_scope():
            ...
            self.l8_0 = L.Linear(obs_size, n_hidden_channels)
            self.l8_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l8_2 = L.Linear(n_hidden_channels, n_actions[8])

            self.l9_0 = L.Linear(obs_size, n_hidden_channels)
            self.l9_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l9_2 = L.Linear(n_hidden_channels, n_actions[9])

            self.l10_0 = L.Linear(obs_size, n_hidden_channels)
            self.l10_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l10_2 = L.Linear(n_hidden_channels, n_actions[10])

            self.l11_0 = L.Linear(obs_size, n_hidden_channels)
            self.l11_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l11_2 = L.Linear(n_hidden_channels, n_actions[11])

            self.l12_0 = L.Linear(obs_size, n_hidden_channels)
            self.l12_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l12_2 = L.Linear(n_hidden_channels, n_actions[12])

            self.l13_0 = L.Linear(obs_size, n_hidden_channels)
            self.l13_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l13_2 = L.Linear(n_hidden_channels, n_actions[13])

            self.l14_0 = L.Linear(obs_size, n_hidden_channels)
            self.l14_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l14_2 = L.Linear(n_hidden_channels, n_actions[14])

            self.l15_0 = L.Linear(obs_size, n_hidden_channels)
            self.l15_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l15_2 = L.Linear(n_hidden_channels, n_actions[15])

            self.l16_0 = L.Linear(obs_size, n_hidden_channels)
            self.l16_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l16_2 = L.Linear(n_hidden_channels, n_actions[16])

            self.l17_0 = L.Linear(obs_size, n_hidden_channels)
            self.l17_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l17_2 = L.Linear(n_hidden_channels, n_actions[17])

            self.l18_0 = L.Linear(obs_size, n_hidden_channels)
            self.l18_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l18_2 = L.Linear(n_hidden_channels, n_actions[18])

            self.l19_0 = L.Linear(obs_size, n_hidden_channels)
            self.l19_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l19_2 = L.Linear(n_hidden_channels, n_actions[19])

            self.l20_0 = L.Linear(obs_size, n_hidden_channels)
            self.l20_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l20_2 = L.Linear(n_hidden_channels, n_actions[20])

            self.l21_0 = L.Linear(obs_size, n_hidden_channels)
            self.l21_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l21_2 = L.Linear(n_hidden_channels, n_actions[21])

            self.l22_0 = L.Linear(obs_size, n_hidden_channels)
            self.l22_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l22_2 = L.Linear(n_hidden_channels, n_actions[22])

            self.l23_0 = L.Linear(obs_size, n_hidden_channels)
            self.l23_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l23_2 = L.Linear(n_hidden_channels, n_actions[23])

            self.l24_0 = L.Linear(obs_size, n_hidden_channels)
            self.l24_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l24_2 = L.Linear(n_hidden_channels, n_actions[24])

            self.l25_0 = L.Linear(obs_size, n_hidden_channels)
            self.l25_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l25_2 = L.Linear(n_hidden_channels, n_actions[25])

            self.l26_0 = L.Linear(obs_size, n_hidden_channels)
            self.l26_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l26_2 = L.Linear(n_hidden_channels, n_actions[26])

            self.l27_0 = L.Linear(obs_size, n_hidden_channels)
            self.l27_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l27_2 = L.Linear(n_hidden_channels, n_actions[27])

            self.l28_0 = L.Linear(obs_size, n_hidden_channels)
            self.l28_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l28_2 = L.Linear(n_hidden_channels, n_actions[28])

            self.l29_0 = L.Linear(obs_size, n_hidden_channels)
            self.l29_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l29_2 = L.Linear(n_hidden_channels, n_actions[29])

            self.l30_0 = L.Linear(obs_size, n_hidden_channels)
            self.l30_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l30_2 = L.Linear(n_hidden_channels, n_actions[30])

            self.l31_0 = L.Linear(obs_size, n_hidden_channels)
            self.l31_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l31_2 = L.Linear(n_hidden_channels, n_actions[31])

            self.l32_0 = L.Linear(obs_size, n_hidden_channels)
            self.l32_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l32_2 = L.Linear(n_hidden_channels, n_actions[32])

            self.l33_0 = L.Linear(obs_size, n_hidden_channels)
            self.l33_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l33_2 = L.Linear(n_hidden_channels, n_actions[33])

            self.l34_0 = L.Linear(obs_size, n_hidden_channels)
            self.l34_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l34_2 = L.Linear(n_hidden_channels, n_actions[34])

            self.l35_0 = L.Linear(obs_size, n_hidden_channels)
            self.l35_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l35_2 = L.Linear(n_hidden_channels, n_actions[35])

            self.l36_0 = L.Linear(obs_size, n_hidden_channels)
            self.l36_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l36_2 = L.Linear(n_hidden_channels, n_actions[36])

            self.l37_0 = L.Linear(obs_size, n_hidden_channels)
            self.l37_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l37_2 = L.Linear(n_hidden_channels, n_actions[37])

            self.l38_0 = L.Linear(obs_size, n_hidden_channels)
            self.l38_1 = L.Linear(n_hidden_channels, n_hidden_channels)
            self.l38_2 = L.Linear(n_hidden_channels, n_actions[38])

            self.l39_0 = L.Linear(obs_size, n_hidden_channels)
            self.l39_1 = L.Linear(n_hidden_channels, n_hidden_channels)
